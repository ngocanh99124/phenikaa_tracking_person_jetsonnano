...
class DeepSortParam
{
    public:
        ...
        const std::string video_read() const
        {
        return video_read_;
        }
        const std::string video_write() const
        {
        return video_write_;
        }
        ...
        {
            this->video_read_ = _param.video_read();
            this->video_write_ = _param.video_write();
            this->weights_file = _param.weights();
            this->names_file = _param.names();
            this->step = _param.getStep();
            this->config_file = _param.config();
        ...
        {
            std::cout << "[Video_input]: " << video_read_ << std::endl;
            std::cout << "[Video_folder_out]: " << video_write_ << std::endl;
            ...
            std::cout << "[step_frame]: " << step << std::endl;
    ...
    private:
        int step;
        std::string video_read_;
        std::string video_write_;
